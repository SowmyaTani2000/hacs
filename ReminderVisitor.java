...
public class ReminderVisitor extends NodeVisitor {
	...
	public void visitAssignment(Assignment assignment) {
		...
		{
			m_Reminder.listUpcoming.add("today is " + today.toString() + " " + assignment.assnName + " Due Date is "
					+ assignment.getDueDateString());
		}
		if (nDueDate < ntoday) {
			// put to the
			m_Reminder.listOverdue.add(assignment.assnName + " Due Date is " + assignment.getDueDateString());
		}
